...
import {addNotify, updateWebhookUrl} from "@/app/_actions/bga";

export const WebhookSetting: React.FC<{webhookUrl: string}> = (props) => {
    ...
    return <form
        ...
        action={async (formData) => {
            ...
            try {
                await updateWebhookUrl(formData)
            } catch (e) {
                throw e
            } finally {
                setDisabled(false)
